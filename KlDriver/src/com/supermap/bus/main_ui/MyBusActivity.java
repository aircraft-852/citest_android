...
public class MyBusActivity extends BaseActivity{
		...
		public boolean handleMessage(Message msg) {
			...
			switch(msg.what){
				...
				case WHAT_LOADMYLINES:
					...
					SimpleAdapter simpAdapter=new SimpleAdapter(MyBusActivity.this, 
					...
					break;
				case 852008:
					Toast.makeText(MyBusActivity.this, "功能建设中...", Toast.LENGTH_SHORT).show();
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				...
				if(checkedId==R.id.rdbtn_Start){
					...
					if(1==iStartResult){
						...
						Toast.makeText(MyBusActivity.this, "服务端请求失败，请稍后重试", Toast.LENGTH_LONG).show();
					}
				}else{
		...
		((TextView)findViewById(R.id.txtCurStation)).setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				case MotionEvent.ACTION_UP:
					Toast.makeText(MyBusActivity.this, "滑动事件", Toast.LENGTH_SHORT).show();
					break;
				}
...
//        
//        //Bundle states = savedInstanceState != null? (Bundle) savedInstanceState.getBundle(Android.STATES_KEY) : null;
...
//        mBoday.addView(v);
	...
	public void onBackPressed() {
		...
		if(timeout<1500){
			BaseApp.exit(MyBusActivity.this);
		}else{
			dtOut=new Date();
			Toast.makeText(MyBusActivity.this, "请再按一次退出系统", Toast.LENGTH_LONG).show();
		}
	}
	...
	public void onClick(View v) {
		...
		case R.id.imgCRCode:		//点击二维码，打开二维码刷卡功能
			Intent it=new Intent(MyBusActivity.this,CaptureActivity.class);
			MyBusActivity.this.startActivity(it);
			break;
		default:
			break;
		}
